...
templates['scenario'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "\r\n<div class=\"scenario\" id=\""
    ...
    + "\">\r\n    <!-- Needs 2 checkboxes and a name-->\r\n    <input type=\"checkbox\" name=\"scenario-found\" "
    + alias1(((helper = (helper = lookupProperty(helpers,"found") || (depth0 != null ? lookupProperty(depth0,"found") : depth0)) != null ? helper : alias3),(typeof helper === alias4 ? helper.call(alias2,{"name":"found","hash":{},"data":data,"loc":{"start":{"line":12,"column":49},"end":{"line":12,"column":58}}}) : helper)))
    + ">\r\n    <input type=\"checkbox\" name=\"scenario-completed\" "
    + alias1(((helper = (helper = lookupProperty(helpers,"completed") || (depth0 != null ? lookupProperty(depth0,"completed") : depth0)) != null ? helper : alias3),(typeof helper === alias4 ? helper.call(alias2,{"name":"completed","hash":{},"data":data,"loc":{"start":{"line":13,"column":53},"end":{"line":13,"column":66}}}) : helper)))
